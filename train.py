...
def tRain(
  ...
  if transfer_params == None:
    ...
    training_state = TrainingState(
        optimizer_state = transfer_params.optimizer_state,
        params = transfer_params.params,
        normalizer_params = transfer_params.normalizer_params,
        env_steps = jnp.arange(1, dtype=jnp.int32)
    )
  ...
  for it in range(num_evals_after_init):
    ...
    if process_id == 0:
      ...
      metrics = evaluator.run_evaluation(
          ...
          training_metrics)
      print(metrics)
      is_early_eliminated = progress_fn(current_step, metrics, cmprsn_rewards)
      params = _unpmap(
          (training_state.normalizer_params, training_state.params.policy))
      policy_params_fn(current_step, make_policy, params)
    if is_early_eliminated: 
      break
  ...
  return (make_policy, params, metrics, training_state) # I added training_state to be able to transfer params